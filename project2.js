...
class MeshDrawer {
	...
	draw(trans) {
		...
		gl.vertexAttribPointer(this.texCoordLoc, 2, gl.FLOAT, false, 0, 0);
		 ...
		 gl.bindBuffer(gl.ARRAY_BUFFER, this.normbuffer);
		gl.enableVertexAttribArray(this.normCoordLoc);
		gl.vertexAttribPointer(this.normCoordLoc, 3, gl.FLOAT, false, 0, 0);
...
const meshFS = `
    ...
    vec4 diffColor = vec4(diff, diff, diff, 1.0);
    vec4 ambientColor = vec4(ambient, ambient, ambient, 1.0);

    vec4 litColor = texColor * (diffColor + ambientColor);
